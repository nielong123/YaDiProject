...
import gaode.trajectory.utils.ReadStringUtil;
import gaode.trajectory.adapter.TrajectRunnable.TrajectListener;
...
//    private View infoWindowView;
    ...
    private void displayPolyline() {
        ...
        for (Bean.ReturnValueBean.DataListBean bean : beanList) {
            if (bean != null) {
    ...
    private void upDataMoveMarker(int index) {
        Bean.ReturnValueBean.DataListBean bean = beanList.get(index);
        LatLng latLng = new LatLng(bean.getLat(), bean.getLon());
        if (moveMarker != null) {
